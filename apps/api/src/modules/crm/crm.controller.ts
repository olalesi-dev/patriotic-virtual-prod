    ...
    app
      ...
      .get('/facilities', async ({ user }) => {
        return await db
          .select()
          .from(schema.facilities)
          .where(eq(schema.facilities.organizationId, user.organizationId!))
          .orderBy(desc(schema.facilities.createdAt));
      })
      .post(
        '/facilities',
        async ({ body, user }) => {
      ...
      .get('/vendors', async ({ user }) => {
        return await db
          .select()
          .from(schema.vendors)
          .where(eq(schema.vendors.organizationId, user.organizationId!))
      ...
      .get('/campaigns', async ({ user }) => {
        return await db
          .select()
          .from(schema.campaigns)
          .where(eq(schema.campaigns.organizationId, user.organizationId!))
      ...
      .get('/grants', async ({ user }) => {
        return await db
          .select()
          .from(schema.grantProposals)
          .where(eq(schema.grantProposals.organizationId, user.organizationId!))
          .orderBy(desc(schema.grantProposals.createdAt));
      })
      .post(
        '/grants',
        async ({ body, user }) => {
      ...
      .get('/timesheets', async ({ user }) => {
        return await db
          ...
          .orderBy(desc(schema.timeSheets.date));
      })
      .post(
        '/timesheets',
        async ({ body, user }) => {
      ...
      .get('/compliance', async ({ user }) => {
        return await db
          ...
          .from(schema.complianceDocuments)
          .where(
            eq(schema.complianceDocuments.organizationId, user.organizationId!),
          )
          .orderBy(desc(schema.complianceDocuments.createdAt));
      })
      .post(
        '/compliance',
        async ({ body, user }) => {
