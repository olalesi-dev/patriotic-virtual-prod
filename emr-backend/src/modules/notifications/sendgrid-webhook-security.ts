...
export function verifySendGridWebhookSignature(input: {
    ...
    const verificationKey = asNonEmptyString(input.verificationKey ?? getSendGridWebhookVerificationKey());
...
export function getSendGridWebhookSignatureHeaders(headers: Record<string, unknown>): {
