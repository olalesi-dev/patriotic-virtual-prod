...
import { buildPortalUrl } from '../modules/notifications/links';

dotenv.config({ path: resolve(process.cwd(), '.env') });

const portalLoginUrl = buildPortalUrl('/login');
const providerWaitlistUrl = buildPortalUrl('/waitlist');
const patientScheduleUrl = buildPortalUrl('/patient/scheduled');
const providerCalendarUrl = buildPortalUrl('/calendar');
const bookingUrl = buildPortalUrl('/book');
...
const scenarios = [
    ...
    },
    {
        ...
        templateData: {
            ...
            requested_date: 'April 25, 2026 at 3:00 PM',
            appointment_reason: 'Weight loss consultation request',
            provider_dashboard_url: providerWaitlistUrl,
            platform_name: 'Patriotic Telehealth',
            ...
            requestedDate: 'April 25, 2026 at 3:00 PM',
            appointmentReason: 'Weight loss consultation request',
            providerDashboardUrl: providerWaitlistUrl,
            platformName: 'Patriotic Telehealth',
        },
    },
    {
        ...
        templateData: {
            ...
            reschedule_url: patientScheduleUrl,
            platform_name: 'Patriotic Telehealth',
            recipientType: 'patient',
            patientName: 'Alex Carter',
            providerName: 'Dr. Jordan Reyes',
            ...
            rescheduleUrl: patientScheduleUrl,
            platformName: 'Patriotic Telehealth',
        },
    },
    {
        ...
        templateData: {
            ...
            appointment_time: '5:30 PM',
            appointment_location: 'https://PVT.doxy.me/patrioticvirtualtelehealth',
            reschedule_url: providerCalendarUrl,
            platform_name: 'Patriotic Telehealth',
            recipientType: 'provider',
            patientName: 'Alex Carter',
            providerName: 'Dr. Jordan Reyes',
            ...
            appointmentTime: '5:30 PM',
            appointmentLocation: 'https://PVT.doxy.me/patrioticvirtualtelehealth',
            rescheduleUrl: providerCalendarUrl,
            platformName: 'Patriotic Telehealth',
        },
    },
    {
    ...
    },
    {
        ...
        templateData: {
            ...
            new_time: '6:00 PM',
            appointment_location: 'https://PVT.doxy.me/patrioticvirtualtelehealth',
            manage_url: providerCalendarUrl,
            platform_name: 'Patriotic Telehealth',
            recipientType: 'provider',
            patientName: 'Alex Carter',
            providerName: 'Dr. Jordan Reyes',
    ...
    },
    {
        ...
        templateData: {
            ...
            appointment_time: '4:00 PM',
            cancellation_reason: 'Provider unavailable',
            schedule_url: providerCalendarUrl,
            platform_name: 'Patriotic Telehealth',
            recipientType: 'provider',
            patientName: 'Alex Carter',
            providerName: 'Dr. Jordan Reyes',
            ...
            appointmentTime: '4:00 PM',
            cancellationReason: 'Provider unavailable',
            scheduleUrl: providerCalendarUrl,
            platformName: 'Patriotic Telehealth',
        },
    },
    {
