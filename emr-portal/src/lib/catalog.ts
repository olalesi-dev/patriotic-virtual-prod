...
export const svcs: Service[] = [
    ...
    { id: 'membership-elite', k: 'membership_elite', name: 'All Access — Elite', desc: 'Everything: telehealth visits, specialty programs, priority radiology reviews, and priority scheduling.', icon: '🏆', ic: 'amber', c: 'amber', price: 199, priceSuffix: '/mo', cat: ['popular', 'membership'], stripe: 'prod_TsnS735VNACb3g', priceId: 'PRICE_ID_ELITE' },
    ...
    { id: 'ai-assistant', k: 'ai_assistant', name: 'Care Navigation Support', desc: 'Administrative guidance and care navigation to help you manage your telehealth journey. Not a substitute for professional medical advice.', icon: '💬', ic: 'emerald', c: 'emerald', price: 29, cat: ['ai'], stripe: 'prod_TsnOx9T2J8z8Bz', priceId: 'PRICE_ID_AI_ASSISTANT' },
    ...
    { id: 'membership-plus', k: 'membership_plus', name: 'All Access — Plus', desc: 'Telehealth visits, care navigation support, and priority scheduling in one subscription.', icon: '⭐', ic: 'blue', c: 'blue', price: 149, priceSuffix: '/mo', cat: ['membership'], stripe: 'prod_TsnRLsuI61fxnt', priceId: 'PRICE_ID_PLUS' },
    { id: 'membership-core', k: 'membership_core', name: 'All Access — Core', desc: 'General telehealth, care navigation support, and priority scheduling. Great starter membership.', icon: '🎯', ic: 'teal', c: 'teal', price: 99, priceSuffix: '/mo', cat: ['membership'], stripe: 'prod_TsnR5LpCR65XOv', priceId: 'PRICE_ID_CORE' },
