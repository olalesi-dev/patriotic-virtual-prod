export const svcs = [
  ...
  },
  {
    ...
    desc: "Confidential men's health evaluation with cardiovascular safety screening. All treatments require review and approval by a licensed physician. Prescriptions are issued only when clinically appropriate.",
    icon: "⚡",
    ic: "blue",
    c: "blue",
    price: 79,
  ...
  },
  {
    ...
    desc: "Comprehensive medical weight management evaluation with eligibility screening, titration planning, and dietary guidance. Medication cost separate. All treatments require review and approval by a licensed physician. Prescriptions are issued only when clinically appropriate.",
    icon: "💊",
    ic: "blue",
    c: "blue",
    price: 129,
