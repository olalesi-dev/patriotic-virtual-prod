export const svcs = [
      ...
      },
      {
        ...
        desc: "Monthly access to digital health tools, educational content & AI-powered navigation features. No clinical services.",
        icon: "📱",
        ic: "violet",
        c: "violet",
        price: 19,
        priceSuffix: "/mo",
        cat: ["ai", "membership"],
        stripe: "prod_TsnTYEU145UpKl",
        priceId: "PRICE_ID_DIGITAL",
      },
      {
        id: "weight-loss",
        k: "weight_loss",
      ...
      },
      {
        ...
        k: "premature_ejaculation",
        name: "Premature Ejaculation",
        desc: "Sertraline (SSRI therapy), topical numbing agents & behavioral techniques. Evidence-based, shipped discreetly.",
        icon: "⏱️",
        ic: "violet",
        c: "violet",
        price: 79,
...

      {
        ...
        desc: "AI-powered health education, symptom guidance & care navigation. Not a substitute for professional medical advice.",
        icon: "🤖",
        ic: "emerald",
        c: "emerald",
        price: 29,
        cat: ["ai"],
        stripe: "prod_TsnOx9T2J8z8Bz",
        priceId: "PRICE_ID_AI_ASSISTANT",
      },
      {
        id: "general-visit",
        k: "general_visit",
...

      {
        ...
        desc: "Telehealth visits, AI health assistant, AI imaging tools, and priority scheduling in one subscription.",
        icon: "⭐",
        ic: "blue",
        c: "blue",
        price: 149,
        priceSuffix: "/mo",
        cat: ["membership"],
        stripe: "prod_TsnRLsuI61fxnt",
        priceId: "PRICE_ID_PLUS",
      },
      {
        id: "membership-core",
        k: "membership_core",
        name: "All Access — Core",
        desc: "General telehealth, AI health assistant, AI imaging tools & scheduling. Great starter membership.",
        icon: "🎯",
        ic: "teal",
        c: "teal",
        price: 99,
        priceSuffix: "/mo",
        cat: ["membership"],
        stripe: "prod_TsnR5LpCR65XOv",
        priceId: "PRICE_ID_CORE",
      },
      {
        id: "telehealth-premium",
        k: "telehealth_premium",
        name: "Telehealth Premium",
        desc: "Unlimited/priority access to general telehealth for non-emergency concerns, clinician visits & digital support.",
        icon: "⚕️",
        ic: "emerald",
        c: "emerald",
        price: 99,
        priceSuffix: "/mo",
        cat: ["membership"],
        stripe: "prod_TsnNYdVBqlNpxO",
        priceId: "PRICE_ID_TH_PREMIUM",
      },
      {
        id: "telehealth-standard",
        k: "telehealth_standard",
        name: "Telehealth Standard",
        desc: "1 visit/month to general telehealth for non-emergency medical concerns, plus clinician visits & digital support.",
        icon: "📋",
        ic: "blue",
        c: "blue",
        price: 59,
        priceSuffix: "/mo",
        cat: ["membership"],
        stripe: "prod_TsnM0Eu3XY9ckD",
        priceId: "PRICE_ID_TH_STANDARD",
      },
      {
        id: "telehealth-basic",
        k: "telehealth_basic",
        name: "Telehealth Basic",
        desc: "AI + limited visits for general telehealth. Digital support & care navigation for non-emergency concerns.",
        icon: "💡",
        ic: "violet",
        c: "violet",
        price: 29,
        priceSuffix: "/mo",
        cat: ["membership"],
        stripe: "prod_TsnLdFSY23zwtS",
        priceId: "PRICE_ID_TH_BASIC",
      },
    ];
export const iQs = {
      general_visit: [
      ...
      weight_loss: [
        {
          k: "currentWeight",
          l: "Current weight (lbs)?",
          t: "i",
          p: "e.g. 210",
        },
        { k: "height", l: "Height (inches)?", t: "i", p: "e.g. 68" },
        {
          k: "previousWeightLoss",
          l: "Prior weight loss attempts?",
          t: "i",
          p: "Describe past efforts",
        },
        {
          k: "hasMedullaryThyroidCancer",
          l: "History of medullary thyroid carcinoma?",
          t: "yn",
        },
      ...
      erectile_dysfunction: [
        {
          k: "symptomDuration",
          l: "How long have you experienced ED?",
          t: "i",
          p: "e.g. 6 months",
        },
        {
          k: "takesNitrates",
          l: "Take nitrate medications (nitroglycerin, isosorbide)?",
          t: "yn",
        },
        { k: "recentStroke", l: "Stroke in past 6 months?", t: "yn" },
        { k: "recentMI", l: "Heart attack in past 6 months?", t: "yn" },
        {
          k: "hasCardiovascularDisease",
      ...
      premature_ejaculation: [
        {
          k: "symptomDuration",
          l: "How long have you experienced PE?",
          t: "i",
          p: "e.g. 1 year",
        },
      ...
      membership_elite: [
        {
          k: "primaryGoal",
          l: "What is your primary health goal?",
          t: "i",
          p: "e.g. Weight loss, hormone balance, general wellness",
        },
        {
          k: "symptomDuration",
          l: "Any specific symptoms currently?",
          t: "i",
          p: "Describe any issues",
        },
        {
          k: "medicalHistory",
          l: "Any chronic medical conditions?",
          t: "i",
          p: "List conditions",
        },
        {
      ...
      imaging_video: [
        {
          k: "imagingType",
          l: "What type of imaging (MRI, CT, X-Ray)?",
          t: "i",
          p: "e.g. MRI of Knee",
        },
        {
        ...
        {
          k: "reasonForConsult",
          l: "Primary reason for consultation?",
          t: "i",
          p: "What would you like the doctor to review?",
        },
      ],
      digital_platform: [
        {
          k: "goals",
          l: "Primary health goals?",
          t: "i",
          p: "Education, tracking, navigation details",
        },
        {
          k: "accessDevice",
          l: "Do you have a smartphone or computer?",
          t: "yn",
        },
      ],
      ai_imaging: [
        {
          k: "examType",
          l: "Type of imaging exam?",
          t: "i",
          p: "e.g. Brain MRI, Chest CT",
        },
        {
          k: "hasDigitalFiles",
          l: "Do you have the digital image files (DICOM)?",
          t: "yn",
        },
      ],
      report_interpretation: [
        {
          k: "reportSummary",
          l: "Briefly describe the report findings:",
          t: "i",
          p: "What did the report say?",
        },
        {
          k: "mainQuestion",
          l: "What is your main question about the report?",
          t: "i",
        },
      ],
      standard_imaging: [
      ...
      diagnostic_single: [
        ...
        {
          k: "indication",
          l: "Reason for exam (Clinical Indication)?",
          t: "i",
        },
      ],
      diagnostic_second: [
        ...
        {
          k: "discrepancyConcern",
          l: "Do you suspect a misdiagnosis?",
          t: "yn",
        },
        {
          k: "specificQuestion",
          l: "Specific question for radiologist?",
          t: "i",
        },
      ],
      diagnostic_facility: [
      ...
      ai_assistant: [
        {
          k: "healthFocus",
          l: "Primary area of health interest?",
          t: "i",
          p: "e.g. Heart health, Lab interpretation",
        },
        {
          k: "techComfort",
          l: "Comfort with technology?",
          t: "i",
          p: "High, Medium, Low",
        },
      ],
      membership_plus: [
        ...
        {
          k: "chronicConditions",
          l: "Do you manage any chronic conditions?",
          t: "i",
          p: "Diabetes, Hypertension, etc.",
        },
      ...
      membership_core: [
        ...
        {
          k: "primaryCareNeeds",
          l: "Looking for primary care support?",
          t: "yn",
        },
      ],
      telehealth_premium: [
