...
export default function HelpPage() {
    return (
        <div className="p-8">
            <h1 className="text-3xl font-black text-slate-800 dark:text-slate-100 tracking-tight mb-4">Support & Help</h1>
            <div className="bg-white dark:bg-slate-800 p-12 rounded-[40px] shadow-xl border border-slate-100 dark:border-slate-700 text-center">
                ...
                <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-2">Need Assistance?</h2>
