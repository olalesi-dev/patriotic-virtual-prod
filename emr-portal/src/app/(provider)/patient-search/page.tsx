...
export default function PatientSearchPage() {
    ...
    return (
        <div className="flex flex-col gap-8 max-w-6xl mx-auto py-8 px-4">
            <div className="flex justify-between items-center bg-white dark:bg-slate-800 dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 dark:border-slate-700">
                <div>
                    <h1 className="text-3xl font-black text-slate-800 dark:text-slate-100 dark:text-slate-100 tracking-tight">Global Patient Search</h1>
            ...
            <div className="relative group w-full">
                ...
                <input
                    ...
                    className="w-full pl-18 pr-8 py-7 bg-white dark:bg-slate-800 dark:bg-slate-800 border-2 border-slate-100 dark:border-slate-700 dark:border-slate-700 rounded-3xl text-2xl font-medium focus:outline-none focus:border-brand focus:ring-8 focus:ring-brand/5 shadow-xl shadow-slate-200/50 dark:shadow-none transition-all placeholder:text-slate-300"
                    autoFocus
                />
            </div>

            {query.trim() !== '' && (
                <div className="bg-white dark:bg-slate-800 dark:bg-slate-800 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-700 dark:border-slate-700 overflow-hidden divide-y divide-slate-50 dark:divide-slate-700">
                        ...
                        results.map(p => (
                            ...
                            >
                                <div className="flex items-center gap-5">
                                    ...
                                    <div>
                                        <h4 className="text-xl font-bold text-slate-800 dark:text-slate-100 dark:text-slate-100 group-hover:text-brand transition-colors">{p.name}</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-white dark:bg-slate-800 dark:bg-slate-800 p-8 rounded-3xl border border-slate-100 dark:border-slate-700 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex items-center gap-4 mb-6">
                        <div className="w-10 h-10 bg-indigo-50 dark:bg-indigo-900/30 rounded-xl flex items-center justify-center">
                            <Clock className="w-5 h-5 text-indigo-500" />
                        </div>
                        <h3 className="font-black text-lg text-slate-800 dark:text-slate-100 dark:text-slate-100 uppercase tracking-tight">Recent</h3>
                    </div>
                    {recentPatients.length > 0 ? (
                        <div className="space-y-4">
                            {recentPatients.map(p => (
                                ...
                                >
                                    <div className="w-10 h-10 bg-slate-100 dark:bg-slate-700 rounded-xl flex items-center justify-center text-xs font-bold text-slate-600 dark:text-slate-300 dark:text-slate-300">
                                        {p.name.split(' ').map(n => n[0]).join('')}
                                    </div>
                                    <div className="flex-1">
                                        <div className="text-sm font-bold text-slate-800 dark:text-slate-100 dark:text-slate-200">{p.name}</div>
                ...
                <div className="bg-white dark:bg-slate-800 dark:bg-slate-800 p-8 rounded-3xl border border-slate-100 dark:border-slate-700 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <h3 className="font-black text-lg text-slate-800 dark:text-slate-100 dark:text-slate-100 uppercase tracking-tight">Pinned</h3>
                    </div>
                    <div className="py-8 text-center bg-slate-50/50 dark:bg-slate-900/30 rounded-2xl border-2 border-dashed border-slate-100 dark:border-slate-700 dark:border-slate-700">
                ...
                <div className="bg-white dark:bg-slate-800 dark:bg-slate-800 p-8 rounded-3xl border border-slate-100 dark:border-slate-700 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <h3 className="font-black text-lg text-slate-800 dark:text-slate-100 dark:text-slate-100 uppercase tracking-tight">My Active</h3>
                    </div>
                    <div className="space-y-4">
