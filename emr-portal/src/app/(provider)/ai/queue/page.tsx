        ...
        <div className="flex flex-col gap-6">
            <div className="flex justify-between items-center">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-100 dark:text-slate-100">AI Action Queue</h1>
                </div>
            ...
            <div className="space-y-4">
                {[
                    ...
                    <div key={i} className="bg-white dark:bg-slate-800 dark:bg-slate-800 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 dark:border-slate-700 shadow-sm hover:shadow-md transition-all group">
                        <div className="flex justify-between items-start mb-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="font-bold text-slate-800 dark:text-slate-100 dark:text-slate-100">{item.patient}</div>
                                </div>
                            </div>
                        ...
                        <p className="text-slate-600 dark:text-slate-300 dark:text-slate-300 bg-slate-50 dark:bg-slate-900/50 dark:bg-slate-900/50 p-4 rounded-xl border border-slate-100 dark:border-slate-700 dark:border-slate-700 mb-6 text-sm leading-relaxed">
                            {item.suggestion}
                        </p>
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div className="flex gap-2">
                                <button className="px-4 py-2 border border-slate-200 dark:border-slate-700 dark:border-slate-700 rounded-lg text-sm font-bold text-slate-600 dark:text-slate-300 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">Dismiss</button>
