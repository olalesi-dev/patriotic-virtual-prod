	...
	return (
		...
		>
			...
			{contextMenu && (
				...
				>
					{["confirmed", "checked_in", "no_show", "completed", "cancelled"].map(
						(s) => (
							<button
								key={s}
								onClick={() => {
		...
		<>
			...
			<div className="fixed right-0 top-0 h-full w-full max-w-sm bg-white shadow-2xl z-50 flex flex-col border-l border-slate-200 animate-in slide-in-from-right duration-300">
				...
				<div className="flex-1 overflow-y-auto p-5 space-y-4">
					...
					<div>
						...
						<div className="grid grid-cols-2 gap-2">
							{(
								["confirmed", "checked_in", "no_show", "completed"] as const
							).map((s) => (
								<button
									key={s}
				...
				<div className="p-5 border-t border-slate-100 space-y-2">
					...
					<button
						onClick={() => onCancelVisit(appt)}
						className="w-full flex items-center justify-center gap-1.5 py-2.5 rounded-xl text-xs font-bold border border-slate-200 text-slate-500 hover:bg-slate-50 transition-colors"
					>
