        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-in fade-in duration-500 text-slate-900 dark:text-white dark:text-slate-100">
            ...
            <div className="lg:col-span-2 space-y-6">
                <section className="bg-white dark:bg-slate-800 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-700 shadow-sm p-6 relative">
                    ...
                    <div className="flex justify-center mb-8">
                        <div className="w-32 h-32 rounded-full bg-sky-100 dark:bg-sky-900/30 text-sky-600 dark:text-sky-400 flex items-center justify-center text-4xl font-bold shadow-inner border-4 border-white dark:border-slate-700">
                            DO
                        </div>
                    </div>
            ...
            <div className="space-y-6">
                ...
                <section className="bg-white dark:bg-slate-800 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-700 shadow-sm p-6">
                    ...
                    <p className="text-xs text-slate-400 dark:text-slate-500 mb-6 font-medium">Manage settings for your language and timezone</p>
                ...
                <section className="bg-white dark:bg-slate-800 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-700 shadow-sm p-6">
                    ...
                    <p className="text-xs text-slate-400 dark:text-slate-500 mb-6 font-medium">Choose between light and dark mode, and customize preferences</p>
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                ...
                <section className="bg-white dark:bg-slate-800 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-700 shadow-sm p-6">
                    ...
                    <div className="bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-800 rounded-lg p-4 flex gap-3">
                        ...
                        <div className="text-xs text-indigo-900 dark:text-indigo-100 leading-relaxed font-medium">
                            ...
                            <span className="underline ml-1 cursor-pointer text-indigo-700 dark:text-indigo-300">Learn more</span>
                        </div>
                    </div>
                </section>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 animate-in fade-in duration-500 text-slate-900 dark:text-white dark:text-slate-100">
            ...
            <div className="lg:col-span-5 space-y-6">
                <section className="bg-white dark:bg-slate-800 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-700 shadow-sm p-6">
                    ...
                    <div className="py-12 flex flex-col items-center justify-center text-center opacity-40">
                        ...
                        <p className="text-sm text-slate-400 dark:text-slate-500 font-medium">Individualized services will appear here</p>
                    </div>
                </section>
            </div>
            ...
            <div className="lg:col-span-7 space-y-6">
                ...
                <section className="bg-white dark:bg-slate-800 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-700 shadow-sm p-6 font-sans">
                    ...
                    <div className="py-2 text-sm text-slate-500 dark:text-slate-400 font-medium italic mb-6">
                        No date overrides have been found.
                    </div>
                    <button className="flex items-center gap-2 text-sm font-bold text-indigo-600 dark:text-indigo-400 hover:underline">
                ...
                <section className="bg-white dark:bg-slate-800 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-700 shadow-sm p-6 overflow-hidden">
                    <div className="flex justify-between items-start mb-2">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <button className="p-1 hover:bg-slate-50 dark:hover:bg-slate-700 rounded text-slate-400 dark:text-slate-500 transition-colors"><Copy className="w-4 h-4" /></button>
                            <button className="p-1 hover:bg-slate-50 dark:hover:bg-slate-700 rounded text-red-400 dark:text-red-500 transition-colors"><Trash2 className="w-4 h-4" /></button>
                        </div>
                    </div>
                    <p className="text-xs text-slate-400 dark:text-slate-500 mb-6 font-medium">
                    ...
                    <div className="bg-indigo-50/70 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-800 rounded-lg p-4 flex gap-3 mb-6">
                        <Info className="w-5 h-5 text-indigo-600 dark:text-indigo-400 flex-shrink-0 mt-0.5" />
                    ...
                    <div className="flex gap-4 border-b border-slate-100 dark:border-slate-700 dark:border-slate-700 mb-6">
                        ...
                        <button className="pb-3 text-sm font-bold text-slate-400 dark:text-slate-500 px-1 flex items-center gap-1 hover:text-slate-600 dark:hover:text-slate-300">
                    ...
                    <div className="space-y-3 pt-4 border-t border-slate-50 dark:border-slate-700">
                        ...
                        {['Saturday', 'Sunday'].map(day => (
                            <div key={day} className="flex items-center justify-between py-1">
                                <div className="text-sm font-bold text-slate-400 dark:text-slate-600 w-32">{day}</div>
                                <div className="flex-1 text-sm font-medium text-slate-400 dark:text-slate-500 italic">Unavailable</div>
                            </div>
                        ))}
                    </div>

                    <button className="flex items-center gap-2 text-sm font-bold text-indigo-600 dark:text-indigo-400 hover:underline mt-8">
    ...
    const renderConnectedApps = () => (
        <div className="space-y-6 animate-in fade-in duration-500 text-slate-900 dark:text-white dark:text-slate-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                    { name: 'Gmail', desc: 'Add Gmail accounts or Google group list', icon: '/google-icon.png', color: 'bg-red-50 dark:bg-red-900/20' },
                    { name: 'Google Calendar', desc: 'Add calendars accounts or Google group list', icon: '/gcal-icon.png', color: 'bg-indigo-50 dark:bg-indigo-900/20' },
                    { name: 'Microsoft Outlook', desc: 'Add a Outlook, Office365 or Exchange account', icon: '/outlook-icon.png', color: 'bg-blue-50 dark:bg-blue-900/20' },
    ...
    const renderNotifications = () => (
        <div className="animate-in fade-in duration-500">
            <section className="bg-white dark:bg-slate-800 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 dark:border-slate-700 shadow-sm p-6 max-w-5xl">
                ...
                <p className="text-xs text-slate-400 dark:text-slate-500 mb-8 font-medium italic">
                    ...
                    {[
                        ...
                        <div key={item.title} className="flex gap-4">
                            ...
                            <div className="flex-1 space-y-4">
                                <div>
                                    <h3 className="text-[15px] font-bold text-indigo-700 dark:text-indigo-400 flex items-center gap-2">
                                        {item.title}
                                        <span className="text-[10px] text-slate-300 dark:text-slate-600">•</span>
                                        <span className="text-[13px] font-medium text-indigo-600 dark:text-indigo-300">{item.type}</span>
                                    </h3>
                                    <p className="text-[13px] text-slate-400 dark:text-slate-500 font-medium leading-relaxed max-w-3xl mt-0.5">
                                        {item.desc}
                                    </p>
                                </div>
                                ...
                                <div className="flex gap-12">
                                    <div className="space-y-1">
                                        <div className="text-[11px] font-bold text-slate-400 dark:text-slate-500 tracking-wider">In-app</div>
                                        <div className={`text-[13px] font-bold ${item.inApp === 'Yes' ? 'text-emerald-500 dark:text-emerald-400' : 'text-slate-300 dark:text-slate-600'}`}>
                                            {item.inApp}
                                        </div>
                                    </div>
                                    {item.email && (
                                        <div className="space-y-1">
                                            <div className="text-[11px] font-bold text-slate-400 dark:text-slate-500 tracking-wider font-sans uppercase">Email</div>
                                            <div className="text-[13px] font-bold text-emerald-500 dark:text-emerald-400">
                                                {item.email}
                                            </div>
                                        </div>
                                    )}
                    ...
                    {['Details', 'Services and availability', 'Connected apps', 'Notifications'].map((tab) => (
                        <button
                            ...
                            className={`pb-4 text-sm font-bold border-b-2 transition-all px-1 tracking-tight ${activeTab === tab
                                ? 'border-indigo-600 text-indigo-600 dark:text-indigo-400 dark:border-indigo-400 translate-y-[1px]'
