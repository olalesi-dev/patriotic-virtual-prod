...
export default function HelpPage() {
    return (
        <div className="p-8">
            <h1 className="text-3xl font-black text-slate-800 tracking-tight mb-4">Provider Support</h1>
            <div className="bg-white p-12 rounded-[40px] shadow-xl border border-slate-100 text-center">
                ...
                <h2 className="text-xl font-bold text-slate-800 mb-2">Clinician Support Desk</h2>
