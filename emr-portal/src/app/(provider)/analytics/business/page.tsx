    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500 text-slate-900 dark:text-slate-100">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <h1 className="text-3xl font-black text-slate-900 dark:text-slate-100 tracking-tight">BUSINESS ANALYTICS</h1>
            ...
            <div className="grid grid-cols-12 gap-8">
                {/* MRR Trend */}
                <div className="col-span-12 lg:col-span-6 bg-white dark:bg-slate-800 p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-700 shadow-sm">
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            <h3 className="text-lg font-black text-slate-900 dark:text-slate-100 leading-none uppercase tracking-tight">MRR Trend</h3>
                ...
                <div className="col-span-12 lg:col-span-6 bg-white dark:bg-slate-800 p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-700 shadow-sm">
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            <h3 className="text-lg font-black text-slate-900 dark:text-slate-100 leading-none uppercase tracking-tight">Acquisition Channels</h3>
            ...
            <div className="grid grid-cols-12 gap-8 pb-12">
                ...
                <div className="col-span-12 lg:col-span-4 bg-white dark:bg-slate-800 p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col">
                    <h3 className="text-lg font-black text-slate-900 dark:text-slate-100 leading-none uppercase tracking-tight mb-8">Revenue by Service</h3>
                            ...
                            {SERVICE_DATA.map((s, i) => (
                                <div key={i} className="flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-[10px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-widest">{s.name}</span>
                                    </div>
                                    <span className="text-xs font-black text-slate-900 dark:text-slate-100">{s.value}%</span>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <div className="col-span-12 lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[
                        ...
                        <div key={i} className="bg-slate-50/50 dark:bg-slate-900 p-6 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm flex items-center gap-6">
                            <div className="w-14 h-14 bg-white dark:bg-slate-800 rounded-2xl flex items-center justify-center shadow-sm">
                                <m.icon className={`w-6 h-6 ${m.color}`} />
                            </div>
                            <div>
                                <div className="text-xl font-black text-slate-900 dark:text-slate-100 tracking-tight">{m.value}</div>
