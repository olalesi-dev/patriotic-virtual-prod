        ...
        <div className="flex flex-col h-[calc(100vh-6rem)] font-sans bg-slate-50 dark:bg-slate-900 relative overflow-hidden text-slate-900 dark:text-slate-100">
            ...
            <div className="p-8 space-y-8 overflow-y-auto h-full">
                ...
                <div>
                    <div className="flex items-center gap-2 mb-4 bg-slate-100/50 dark:bg-slate-800/50 p-2 rounded-lg w-fit">
                        ...
                        <span className="font-bold text-slate-800 dark:text-slate-200">Groups</span>
                        <ChevronDown className="w-4 h-4 text-slate-400 dark:text-slate-500" />
                    </div>

                    <div className="flex gap-6">
                        {/* Intake Folder Card */}
                        <div className="bg-white dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm w-72 hover:shadow-md transition-shadow cursor-pointer group">
                            <div className="flex items-start gap-3 mb-2">
                                ...
                                <div className="flex-1">
                                    <div className="flex items-center gap-2">
                                        <h3 className="font-bold text-slate-900 dark:text-slate-100">Intake</h3>
                        ...
                        {/* Add Folder Button */}
                        <button className="w-72 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 border-dashed flex items-center justify-center hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors shadow-sm group">
                ...
                <div className="pt-4">
                    <div className="flex justify-between items-center mb-4">
                        <div className="flex items-center gap-2 bg-slate-100/50 dark:bg-slate-800/50 p-2 rounded-lg">
                            ...
                            <span className="font-bold text-slate-800 dark:text-slate-200">Defined Protocols</span>
                            <ChevronDown className="w-4 h-4 text-slate-400 dark:text-slate-500" />
                        </div>
                        <button className="text-brand text-sm font-bold flex items-center gap-1 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 px-3 py-1.5 rounded-lg transition-colors border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 dark:text-indigo-400">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 pb-20">
                        {PROTOCOLS.map((protocol, i) => (
                            <div
                                ...
                                className="bg-white dark:bg-slate-800 p-5 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow cursor-pointer flex flex-col h-36 justify-between group"
                            >
                                <div>
                                    <h3 className="font-bold text-slate-800 dark:text-slate-200 text-sm leading-snug line-clamp-2 mb-1 group-hover:text-brand dark:group-hover:text-indigo-400 transition-colors">
                                        {protocol.title}
                                    </h3>
                                ...
                                <div className="flex items-center gap-2 mt-auto">
                                    ...
                                    <span className="text-xs font-bold text-slate-700 dark:text-slate-300">Practice HQ</span>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            {selectedProtocol && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 dark:bg-black/60 backdrop-blur-sm animate-fade-in">
                    <div className="bg-slate-50 dark:bg-slate-900 w-full max-w-6xl h-[90vh] rounded-xl shadow-2xl overflow-hidden animate-scale-up flex border dark:border-slate-800">

                        {/* LEFT SIDEBAR */}
                        <div className="w-80 bg-white dark:bg-slate-800 border-r border-slate-200 dark:border-slate-700 p-8 flex flex-col h-full relative z-10">
                            ...
                            <div className="mt-auto pt-6 flex items-center gap-3 border-t border-slate-100 dark:border-slate-700">
                                ...
                                <span className="text-sm font-bold text-slate-700 dark:text-slate-300">Patriotic Systems</span>
                            </div>
                        </div>
                        ...
                        <div className="flex-1 flex flex-col bg-slate-100 dark:bg-slate-900 relative">
                            {/* Toolbar */}
                            <div className="h-16 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 flex items-center justify-end px-6 gap-2 shadow-sm z-20">
                            ...
                            <div className="flex-1 overflow-y-auto p-12">
                                <div className="bg-white dark:bg-slate-800 max-w-3xl mx-auto min-h-[800px] shadow-sm border border-slate-200 dark:border-slate-700 rounded-xl p-12 relative">
                                    <div className="space-y-6">
                                        ...
                                        <div className="h-4 bg-slate-50 dark:bg-slate-900 w-full rounded"></div>
                                        <div className="h-4 bg-slate-50 dark:bg-slate-900 w-3/4 rounded"></div>
                                        <div className="h-4 bg-slate-50 dark:bg-slate-900 w-1/2 rounded"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
