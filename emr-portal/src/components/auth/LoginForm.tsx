        ...
        >
          <div className="space-y-2">
            <h2 className="text-4xl font-black text-slate-900 tracking-tight leading-tight uppercase">
              PATRIOTIC VIRTUAL EHR
            </h2>
            <p className="text-slate-500 text-sm font-medium leading-relaxed">
              Welcome back. Please authenticate to access your secure medical
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-end ml-1">
                ...
                <Link
                  ...
                  className="text-[10px] font-black text-brand uppercase tracking-widest hover:text-brand-600 transition-colors"
                >
                  Recover
                </Link>
              </div>
            ...
            <div className="flex items-center gap-2 px-1">
              <label className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-slate-400 cursor-pointer hover:text-slate-600 transition-colors">
                <input
                  type="checkbox"
                  className="rounded-md border-slate-200 text-brand focus:ring-brand/20 w-4 h-4"
                />
